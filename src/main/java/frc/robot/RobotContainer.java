...
//joystick tbd...
    ...
    public Command getDistanceAutonomousCommand() {
        Command r_command = Commands.sequence(
            new RunCommand(() -> m_drivetrain.driveAuto(0.25)).withTimeout(0.4),
            new RunCommand(() -> m_drivetrain.driveAuto(-0.4)).withTimeout(0.4), //spaz out for a second to flip down the hinge thingy
